...
class PlutoKeyManagerEvent {
  ...
  bool get isShiftPressed {
    return event.physicalKey == PhysicalKeyboardKey.shiftLeft;
  }

  bool get isCtrlPressed {
    return event.physicalKey == PhysicalKeyboardKey.controlLeft;
  }

  bool get isAltPressed {
    return event.physicalKey == PhysicalKeyboardKey.altLeft;
  }
